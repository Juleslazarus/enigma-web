...
const CreateChat = () => {
                            ...
                            if (chat.exists()) { 
                                ...
                                // get(child(userRef, `users/${uid}`))
                                    // .then(user_info => {
                                        ...
                                        set(ref(db, `users/${uid}/user_chat_rooms/${chatNameInput}/`), {
                                        ...
                                        set(ref(db, `chat_rooms/${chatNameInput}/`),{
                                            chatName: chatNameInput, 
                                            privacyStatus: `${privacyStatus}`, 
                                            key: `${chatKeyInput}`, 
                                        })
  ...
  return (
    <div>
        <label htmlFor="createChatLg" className="hover:cursor-pointer flex justify-center  h-full w-full  "><FaRegEdit/></label>

        <input type="checkbox" id="createChatLg" className="modal-toggle" />
        <div className="modal">
        <div className="modal-box relative flex flex-col gap-4">
            <label htmlFor='createChatLg' className="btn btn-ghost btn-square absolute right-2 top-2" onClick={emptyInputs}>✕</label>
