    ...
    <div className='fixed bottom-4 right-4 overflow-hidden '>
      ...
      <div className='overflow-hidden flex flex-col justify-center items-center'>
        {speedDial? <motion.div initial={{opacity: 0}} animate={{opacity: 1}} transition={{type: 'tween', duration: .3}} className='flex flex-col justify-center items-center gap-6 p-4'>
            <motion.i initial={{y: 10, opacity: 0}} animate={{y: 0, opacity: 1}} transition={{type: 'tween', duration: .08, delay: .4}} className='text-2xl flex justify-center'><SearchModal/></motion.i>
            <motion.i initial={{y: 10, opacity: 0}} animate={{y: 0, opacity: 1}} transition={{type: 'tween', duration: .08, delay: .3}} onClick={speedDialInboxOn} className='text-2xl'><FaInbox/></motion.i>
