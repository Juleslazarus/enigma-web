...
const Auth = () => {
  ...
  return (
    <div className='initialWrapper h-screen w-full bg-[#454E9E] flex flex-col items-center justify-start gap-8 overflow-y-scroll'>
      ...
      <div className='buttonWrapper flex flex-col gap-2 '>
          <RegisterModal/>
          <LoginModal/>
      </div>
    </div>
